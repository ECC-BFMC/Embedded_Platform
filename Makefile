...
INCLUDE_PATHS += -I../
INCLUDE_PATHS += -I../.
INCLUDE_PATHS += -I../libs/mbed-rtos
INCLUDE_PATHS += -I../libs/mbed-rtos/rtos
INCLUDE_PATHS += -I../libs/mbed-rtos/rtx
INCLUDE_PATHS += -I../libs/mbed-rtos/rtx/TARGET_CORTEX_M
INCLUDE_PATHS += -I../libs/mbed-rtos/rtx/TARGET_CORTEX_M/TOOLCHAIN_GCC
INCLUDE_PATHS += -I../libs/mbed-rtos/rtx/TARGET_CORTEX_M/TOOLCHAIN_GCC
INCLUDE_PATHS += -I../libs/mbed-rtos/targets/TARGET_STM
INCLUDE_PATHS += -I../libs/mbed/.
INCLUDE_PATHS += -I../libs/mbed/TARGET_NUCLEO_F401RE
INCLUDE_PATHS += -I../libs/mbed/TARGET_NUCLEO_F401RE/TARGET_STM
INCLUDE_PATHS += -I../libs/mbed/TARGET_NUCLEO_F401RE/TARGET_STM/TARGET_STM32F4
INCLUDE_PATHS += -I../libs/mbed/TARGET_NUCLEO_F401RE/TARGET_STM/TARGET_STM32F4/TARGET_STM32F401xE
INCLUDE_PATHS += -I../libs/mbed/TARGET_NUCLEO_F401RE/TARGET_STM/TARGET_STM32F4/TARGET_STM32F401xE/TARGET_NUCLEO_F401RE
INCLUDE_PATHS += -I../libs/mbed/TARGET_NUCLEO_F401RE/TARGET_STM/TARGET_STM32F4/TARGET_STM32F401xE/device
INCLUDE_PATHS += -I../libs/mbed/TARGET_NUCLEO_F401RE/TARGET_STM/TARGET_STM32F4/device
INCLUDE_PATHS += -I../libs/mbed/TARGET_NUCLEO_F401RE/TOOLCHAIN_GCC_ARM
