...
OBJECTS += mbed-os/features/netsocket/emac-drivers/TARGET_STM/stm32xx_emac.o
...
OBJECTS += mbed-os/targets/TARGET_STM/TARGET_STM32F4/TARGET_STM32F401xE/TARGET_NUCLEO_F401RE/PeripheralPins.o
OBJECTS += mbed-os/targets/TARGET_STM/TARGET_STM32F4/TARGET_STM32F401xE/TARGET_NUCLEO_F401RE/system_clock.o
OBJECTS += mbed-os/targets/TARGET_STM/TARGET_STM32F4/TARGET_STM32F401xE/device/TOOLCHAIN_GCC_ARM/startup_stm32f401xe.o
...
INCLUDE_PATHS += -I../mbed-os/features/netsocket/emac-drivers/TARGET_STM
INCLUDE_PATHS += -I../mbed-os/features/netsocket/emac-drivers/TARGET_STM/TARGET_STM32F4
...
INCLUDE_PATHS += -I../mbed-os/targets/TARGET_STM/TARGET_STM32F4/TARGET_STM32F401xE
INCLUDE_PATHS += -I../mbed-os/targets/TARGET_STM/TARGET_STM32F4/TARGET_STM32F401xE/TARGET_NUCLEO_F401RE
INCLUDE_PATHS += -I../mbed-os/targets/TARGET_STM/TARGET_STM32F4/TARGET_STM32F401xE/device
...
LIBRARY_PATHS :=
LIBRARIES :=
LINKER_SCRIPT ?= ../mbed-os/targets/TARGET_STM/TARGET_STM32F4/TARGET_STM32F401xE/device/TOOLCHAIN_GCC_ARM/STM32F401XE.ld

# Objects and Paths
###############################################################################
# Tools and Flags

AS      = '$(GCC_ARM_FOLDER)/arm-none-eabi-gcc' 
CC      = '$(GCC_ARM_FOLDER)/arm-none-eabi-gcc' 
CPP     = '$(GCC_ARM_FOLDER)/arm-none-eabi-g++' 
LD      = '$(GCC_ARM_FOLDER)/arm-none-eabi-gcc' 
ELF2BIN = '$(GCC_ARM_FOLDER)/arm-none-eabi-objcopy'
PREPROC = '$(GCC_ARM_FOLDER)/arm-none-eabi-cpp' '-E' '-P' '-Wl,--gc-sections' '-Wl,--wrap,main' '-Wl,--wrap,_malloc_r' '-Wl,--wrap,_free_r' '-Wl,--wrap,_realloc_r' '-Wl,--wrap,_memalign_r' '-Wl,--wrap,_calloc_r' '-Wl,--wrap,exit' '-Wl,--wrap,atexit' '-Wl,-n' '-mcpu=cortex-m4' '-mthumb' '-mfpu=fpv4-sp-d16' '-mfloat-abi=softfp' '-Wall' '-Wextra' '-Wno-unused-parameter' '-Wno-missing-field-initializers' '-fmessage-length=0' '-fno-exceptions' '-ffunction-sections' '-fdata-sections' '-funsigned-char' '-MMD' '-fomit-frame-pointer' '-Os' '-g' '-DMBED_TRAP_ERRORS_ENABLED=1' '-mcpu=cortex-m4' '-mthumb' '-mfpu=fpv4-sp-d16' '-mfloat-abi=softfp' '-DMBED_ROM_START=0x8000000' '-DMBED_ROM_SIZE=0x80000' '-DMBED_RAM_START=0x20000000' '-DMBED_RAM_SIZE=0x18000' '-DMBED_BOOT_STACK_SIZE=1024'
...
C_FLAGS += -DMBED_BUILD_TIMESTAMP=1633528132.7811553
...
C_FLAGS += -DTARGET_NAME=NUCLEO_F401RE
...
CXX_FLAGS += -DMBED_BUILD_TIMESTAMP=1633528132.7811553
...
CXX_FLAGS += -DTARGET_NAME=NUCLEO_F401RE
...
ASM_FLAGS += -I../mbed-os/features/netsocket/emac-drivers/TARGET_STM
ASM_FLAGS += -I../mbed-os/features/netsocket/emac-drivers/TARGET_STM/TARGET_STM32F4
...
ASM_FLAGS += -I../mbed-os/targets/TARGET_STM/TARGET_STM32F4/TARGET_STM32F401xE/device
